export default function Plan() {
  return (
    <div className='rounded-2xl bg-background-secondary p-5'>
      <h2 className='border-b border-border pb-3 text-2xl sm:text-3xl font-bold text-text-primary'>
        Advanced
      </h2>
      <div className='my-4'>
        <h2 className='sm:text-lg font-semibold text-text-primary '>Get new experience</h2>
      ...
      <button className='mt-5 w-full rounded-3xl bg-settings-active py-3 transition-colors duration-500 hover:bg-settings-inactive '>
        <span className='text-3xl sm:text-4xl font-bold text-text-primary'>$5.99</span>
        <span className='text-xs sm:text-sm font-medium text-text-secondary'>/month</span>
      </button>
    </div>
  );
}
